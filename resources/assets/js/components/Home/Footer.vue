...
<script>
    export default {
        ...
        computed: {
            userLocationButton() {
                return this.$store.state.maps.userLocationButton
            },
            targetLocationButton() {
                return this.$store.state.maps.targetLocationButton
            }
        },
        methods: {
            userLocation() {
                this.$store.dispatch('SHOW_USER_LOCATION');
            },
            targetLocation() {
                this.$store.dispatch('SHOW_TARGET_LOCATION');
            }
        }
    }
</script>